...
void GetConfigData() {
      ...
      root_out["kNO"] = String(eepromData.kNO);
      root_out["kNO2"] = String(eepromData.kNO2);
      root_out["kCO"] = String(eepromData.kCO);
      root_out["kSO2"] = String(eepromData.kSO2);
      root_out["kH2S"] = String(eepromData.kH2S);
      root_out["kO3low"] = String(eepromData.kO3low);
      root_out["kO3high"] = String(eepromData.kO3high);
      root_out["kC6H6"] = String(eepromData.kC6H6);
